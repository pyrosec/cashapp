...
(function (global, factory) {
...
}(this, (function (exported, tslib) { 'use strict';
    var self: any = this;
    var window: any = {};
    window.navigator = {};
    ...
    var EncryptThenAuthenticate = /** @class */ (function (_super) {
        ...
        EncryptThenAuthenticate.prototype.encrypt = function (plaintext, associatedData) {
            if (associatedData === void 0) { associatedData = new Uint8Array(0); }
                ...
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            if (!(ciphertext.length > CryptoFormat.NON_RAW_PREFIX_SIZE)) return [3 /*break*/, 6];
                ...
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            _a.label = 1;
                        case 1:
                            if (!(i < entriesArrayLength)) return [3 /*break*/, 7];
                ...
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            _a.label = 1;
                        case 1:
                            if (!(i < keysLength)) return [3 /*break*/, 7];
                            key = keys[i];
                            if (!(key.getStatus() === PbKeyStatusType.ENABLED)) return [3 /*break*/, 6];
                            ...
                            if (!(opt_customKeyManager &&
                                opt_customKeyManager.getKeyType() === keyData.getTypeUrl())) return [3 /*break*/, 3];
                ...
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            _a.label = 1;
                        case 1:
                            if (!(i < primitivesLength)) return [3 /*break*/, 7];
    ...
    function fromJsonWebKey$5(jwk, hash, encoding) {
        if (encoding === void 0) { encoding = EcdsaSignatureEncodingType.IEEE_P1363; }
        return __awaiter$l(this, void 0, void 0, function () {
            var crv, cryptoKey;
            return tslib.__generator(this, function (_a) {
                switch (_a.label) {
                ...
                return tslib.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            requireUint8Array(signature);
                            requireUint8Array(data);
                            if (!(signature.length > CryptoFormat.NON_RAW_PREFIX_SIZE)) return [3 /*break*/, 6];
